...
const CatalogPage: NextPage = () => {
  ...
  const courses: Course[] = [
    {
      ...
      description: 'Learn the fundamentals of HTML, CSS, and JavaScript to create modern websites.',
    ...
    },
    {
      ...
      rating: 4.7,
      enrolledStudents: 1578,
    },
    {
      id: '4',
      title: 'UI/UX Design Principles',
      instructor: 'David Kim',
      description: 'Learn essential design principles and tools for creating engaging user experiences.',
      thumbnail: '/images/ui-ux.jpg',
      duration: '7 weeks',
      level: 'Beginner',
      category: 'Design',
      rating: 4.6,
      enrolledStudents: 1092,
    },
    {
      id: '5',
    ...
    },
    {
      ...
      description: 'Learn to implement continuous integration and deployment workflows for software development.',
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      <Head>
        <title>Course Catalog | LMS Platform</title>
        <meta name="description" content="Browse our collection of courses" />
      ...
      <main className="max-w-7xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
        <div className="mb-8">
          ...
          <p className="text-gray-500">Discover courses to enhance your skills and advance your career</p>
        </div>

        {/* Search and Filters */}
        <div className="bg-white p-4 text-black rounded-lg shadow-md mb-8">
          <div className="flex flex-col  lg:flex-row lg:items-center space-y-4 lg:space-y-0 lg:space-x-4">
            <div className="flex-1">
              <input
                type="text"
                placeholder="Search courses..."
                className="w-full px-4 py-2 border border-blue-500 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-800"
                value={searchTerm}
            ...
            <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
              <select
                className="px-4 py-2 border border-blue-500 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-800"
              ...
              <div key={course.id} className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition duration-300">
                ...
                <div className="p-4">
                  <div className="flex justify-between items-start mb-2">
                    <span className="inline-block px-2 py-1 text-xs font-semibold bg-indigo-100 text-blue-800 rounded-full">
                      {course.category}
                    </span>
                  ...
                  <Link href={`/courses/${course.id}`} className="block w-full text-center bg-blue-600 text-white py-2 rounded-md font-medium hover:bg-blue-500 transition">
      ...
      <footer className="bg-gray-800 text-white mt-12">
        <div className="max-w-7xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <h3 className="text-xl font-bold mb-4">QuisefLearn</h3>
              <p className="text-gray-400">Empowering learners worldwide with quality education and skills development.</p>
            </div>
            <div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="#" className="text-gray-400 hover:text-white transition">Cookie Settings</a></li>
              </ul>
            </div>
          </div>
          <div className="border-t border-gray-700 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400">© 2025 QuisefLearn. All rights reserved.</p>
